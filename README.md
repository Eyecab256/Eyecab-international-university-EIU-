...
<section class="hero" id="home">
    <div class="container hero-content">
        ...
        <div class="hero-btns">
            ...
            <a href="#application" class="btn btn-outline">Apply Now</a>
        </div>
    </div>
</section>
        ...
        <div class="programs-grid">
            <div class="program-card" data-category="business engineering">
                ...
                <div class="program-card-content">
                    ...
                    <div class="program-meta">3 Years | Day Programme</div>
            ...
            <div class="program-card" data-category="health">
                ...
                <div class="program-card-content">
                    ...
                    <div class="program-meta">5 Years | Day Programme</div>
            ...
            <div class="program-card" data-category="engineering">
                ...
                <div class="program-card-content">
                    ...
                    <div class="program-meta">4 Years | Day Programme</div>
        ...
        <form id="applicationForm" action="submit_application.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select id="programme" name="programme" required>
                    ...
                    <!-- Business School -->
                    <option value="commerce-bs" data-college="business-school">Bachelor of Commerce (3 Years)</option>
                    <option value="business-admin-bs" data-college="business-school">Bachelor of Business Administration (3 Years)</option>
                    <option value="hr" data-college="business-school">Bachelor of Human Resource Management (3 Years)</option>
                    <option value="international" data-college="business-school">Bachelor of International Business (3 Years)</option>
                    <option value="leisure" data-college="business-school">Bachelor of Leisure, Events and Hotel Management (3 Years)</option>
                    <option value="business-computing" data-college="business-school">Bachelor of Business Computing (3 Years)</option>
                    <option value="procurement" data-college="business-school">Bachelor of Procurement and Supply Chain Management (3 Years)</option>
                    <option value="real-estate" data-college="business-school">Bachelor of Real Estate Business Management (3 Years)</option>
                    <option value="leadership" data-college="business-school">Bachelor of Leadership and Governance (3 Years)</option>
                    <option value="economics-bs" data-college="business-school">Bachelor of Arts in Economics (3 Years)</option>
                    <option value="finance" data-college="business-school">Bachelor of Science in Finance (3 Years)</option>
                    <option value="accounting" data-college="business-school">Bachelor of Science in Accounting (3 Years)</option>
                    <option value="business-stats" data-college="business-school">Bachelor of Business Statistics (3 Years)</option>
                    <option value="office" data-college="business-school">Bachelor of Office & Information Management (3 Years)</option>
                    <option value="marketing" data-college="business-school">Bachelor of Marketing (3 Years)</option>
                    <option value="travel" data-college="business-school">Bachelor of Travel and Tourism Management (3 Years)</option>
                    <option value="entrepreneurship" data-college="business-school">Bachelor of Entrepreneurship (3 Years)</option>
                    <option value="transport" data-college="business-school">Bachelor of Transport and Logistics Management (3 Years)</option>
...
<footer class="footer" id="footer">
    <div class="container">
        ...
        <p style="margin-top: 2rem; text-align: center;">&copy; 2025 Eyecab International University. All rights reserved.</p>
    </div>
</footer>
...
<div class="live-chat-widget" id="liveChatWidget">
    <div class="chat-header">
        <h4>Live Chat</h4>
        <button id="closeChatBtn" style="background: none; border: none; color: white; font-size: 1.2rem;">×</button>
    </div>
    <div class="chat-body" id="chatBody">
        <div class="chat-message user">Hi, I have a question about the application process.</div>
        <div class="chat-message agent">Hello! I'd be happy to help with your application questions. What would you like to know?</div>
    </div>
...
<script>
    ...
    for (let i = 0; i < programmeSelect.options.length; i++) {
        ...
        if (option.value && option.dataset.college) {
            secondChoice.add(new Option(option.text, option.value));
        }
    }
    ...
    function sendAIQuestion() {
        ...
        if (question) {
            ...
            setTimeout(() => {
                ...
                aiResponse.innerHTML = `<strong>EYECAB Assistant:</strong> ${responses[randomIndex]}`;
    ...
    document.getElementById('applicationForm').addEventListener('submit', function(e) {
        e.preventDefault();
        alert("Thank you for applying! Your form has been submitted.");
        this.reset();
    });
